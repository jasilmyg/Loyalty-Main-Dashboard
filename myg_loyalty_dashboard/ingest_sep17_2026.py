"""
ingest_sep17_2026.py
========================
Loads Sep 17, 2026 data into both Azure ClickHouse tables.

File naming convention (file named DD+1 contains data for DD):
  - Sep 17 data is in files named 18-09-2026
...
FILES = [
    (
        "item_wise_sales_report/item_wise_sales_report_18-09-2026_03_00_02_211961.csv",
        "invoice_wise_sales_report/invoice_wise_sales_report_18-09-2026_03_00_03_313712.csv",
        "Sep 17"
    ),
]
...
print("\n" + "="*70)
print("  Ingesting Sep 17, 2026 into azure_sales_report & azure_invoice_report")
print("="*70)
...
print("\n  Per-day counts for Sep 17:")
for table in ['azure_sales_report', 'azure_invoice_report']:
    cnt = client.query(f"SELECT count() FROM {table} WHERE date = '2026-09-17'").result_rows[0][0]
    status = 'OK' if cnt > 0 else 'MISSING'
    print(f"    [{status}] {table} | 2026-09-17: {cnt:,} rows")
