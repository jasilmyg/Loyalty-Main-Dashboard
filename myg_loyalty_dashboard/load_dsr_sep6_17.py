...
load_dsr_sep6_17.py
====================
Loads DSR SEP 6-17 2026.xlsx into the sales_data ClickHouse table.
Column structure is identical to previous DSR loads.
"""
...
TABLE       = 'sales_data'
EXCEL       = r'C:\Users\jasil_myg\Desktop\myG Loyalty Main Dashboard\project_folder\DSR SEP 6-17 2026.xlsx'
SOURCE_FILE = 'DSR SEP 6-17 2026.xlsx'
...
print('[7] Date verification (Sep 6-17):')
for d in ['2026-09-06','2026-09-07','2026-09-08','2026-09-09','2026-09-10',
          '2026-09-11','2026-09-12','2026-09-13','2026-09-14','2026-09-15',
          '2026-09-16','2026-09-17']:
    cnt = client.query(f"SELECT count() FROM sales_data WHERE parsed_date = '{d}'").result_rows[0][0]
