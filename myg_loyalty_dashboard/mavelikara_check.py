...
BRANCH = 'MAVELIKARA FUTURE'
dates = ['2026-06-27', '2026-06-28']

with connection.cursor() as cur:

    # ── PER-DAY (Brand-Wide repeat logic) ─────────────────
    ...
    for date_str in dates:
        cur.execute("""
            ...
            first_purchase AS (
                -- Their first-ever purchase date ANYWHERE (NO branch filter here)
    ...
    # ── COMBINED (Unique customers, Brand-Wide repeat logic) ────────────
    ...
    cur.execute("""
        ...
        SELECT
            COUNT(*) AS total,
            -- New = first purchase ANYWHERE falls within our 2-day window
            COUNT(CASE WHEN first_date >= '2026-06-27' AND first_date <= '2026-06-28' THEN 1 END) AS new_c,
            -- Repeat = had at least one purchase ANYWHERE BEFORE 27 June
